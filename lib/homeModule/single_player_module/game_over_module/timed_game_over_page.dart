...
class TimedGameOverPage extends StatefulWidget {
  @override
  _TimedGameOverPageState createState() => _TimedGameOverPageState();
}

class _TimedGameOverPageState extends State<TimedGameOverPage> with BaseClass {
  ...
  Widget build(BuildContext context) {
    ...
    String highestScore;
    if (sharePrefProvider.userDataModel.timedModeRemovedCategories.length ==
            0 &&
        sharePrefProvider.userDataModel.timedModeRemovedSubcategories.length ==
            0) {
      if (int.parse(sharePrefProvider.userDataModel.timedModeHighScore) <
          questionProvider.getCorrectAnswersCount) {
        optionProvider.setUserTimedHighScore(
        ...
        highestScore = sharePrefProvider.userDataModel.timedModeHighScore;
      }
    } else {
      highestScore = sharePrefProvider.userDataModel.timedModeHighScore;
    }
                                ...
                                children: [
                                  ...
                                  RoundedEdgeButton(
                                      ...
                                      onPressed: (value) {
                                        ...
                                        questionProvider.resetTimedTimer();
                                        /*
                                  ...
                                  RoundedEdgeButton(
                                      ...
                                      onPressed: (value) {
                                        pushToNextScreenWithFadeAnimation(
                                          context: context,
                                          destination: YourAnswersEndlessMode(),
                                        );
                                      },
                                      context: context),
                                  RoundedEdgeButton(
