...
class GlobalLeaderBoardHighScorePage extends StatefulWidget {
  @override
  _GlobalLeaderBoardHighScorePageState createState() =>
      _GlobalLeaderBoardHighScorePageState();
}

class _GlobalLeaderBoardHighScorePageState
    extends State<GlobalLeaderBoardHighScorePage> {
  @override
  void initState() {
    var leaderBoardProvider =
        Provider.of<LeaderBoardProvider>(context, listen: false);
    leaderBoardProvider.getAllUsers(leaderBoardProvider);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: leaderBoardProvider.usersList.length == 0
          ? Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ListView.builder(
                                      itemCount:
                                          leaderBoardProvider.usersList.length,
                                ...
                                Align(
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Text(
                                        "You: ${leaderBoardProvider.getEndlessRank()} ${getTrailingString(leaderBoardProvider.getEndlessRank())}",
                                        style: TextStyle(
                                            color: successColor,
